      ...
      >
        ...
        <div className="space-y-2">
          <input
            ...
            className="w-full bg-black/40 md:bg-slate-50 border border-white/10 md:border-slate-300 rounded-[10px] px-3 py-3 text-sm text-white md:text-slate-900 placeholder:text-slate-500"
          />
          <input
            type="email"
            value={email}
          ...
          <textarea
            ...
            className="w-full bg-black/40 md:bg-slate-50 border border-white/10 md:border-slate-300 rounded-[10px] px-3 py-3 text-sm text-white md:text-slate-900 placeholder:text-slate-500 resize-none"
          />
        </div>
        <button
          onClick={submit}
          disabled={busy}
          className="mt-3 w-full inline-flex items-center justify-center gap-1.5 py-3 rounded-[10px] bg-fuchsia-500 hover:bg-fuchsia-400 disabled:opacity-60 text-black font-bold text-sm"
        >
