      ...
      {isOwner && (
        <div className="mt-4 space-y-2 rounded-2xl border border-white/10 bg-white/[0.03] p-3">
          ...
          <input
            ...
            placeholder="Title"
            className="w-full rounded-[10px] border border-white/10 bg-white/[0.05] px-3 py-2 text-[12px] text-white placeholder:text-slate-500"
          />
          <input
            value={url}
          ...
          <button
            ...
            className="w-full rounded-[10px] py-2 text-[12px] font-bold text-white disabled:opacity-50"
            style={{ background: ACCENT }}
          >
    ...
    <Sheet onClose={onClose}>
      ...
      <div className="mt-4 space-y-2">
        <input
          ...
          className="w-full rounded-[10px] border border-white/10 bg-white/[0.05] px-3 py-2 text-[13px] text-white placeholder:text-slate-500"
        />
        <textarea
          value={description}
          ...
          rows={3}
          className="w-full resize-none rounded-[10px] border border-white/10 bg-white/[0.05] px-3 py-2 text-[12px] text-white placeholder:text-slate-500"
        />
        <input
          value={coverUrl}
        ...
        <button
          ...
          className="flex w-full items-center justify-between rounded-[10px] border border-white/10 bg-white/[0.05] px-3 py-2 text-[12px] font-semibold text-white"
        >
