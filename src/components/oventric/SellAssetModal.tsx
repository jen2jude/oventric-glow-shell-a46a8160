...
import { createProduct, listMarketplaceCategories, FX_FROM_USD, type ProductCategory, type CategoryNode, type OrderCurrency } from "@/lib/marketplace.functions";
...
export function SellAssetModal({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  return (
    <div className="modal-light fixed inset-0 z-[70] flex items-end justify-center sm:items-center" role="dialog" aria-modal="true" aria-label="Sell an asset">
