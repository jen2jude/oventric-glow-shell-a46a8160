      ...
      <div className="h-16 flex items-center gap-3 px-4 md:px-6">
        ...
        <div className="flex items-center gap-2 ml-auto shrink-0">
          ...
          <button
            ...
            className="relative p-1.5 rounded-full border-2 border-white bg-[#1E1E24]/60 text-white transition-transform duration-150 hover:-translate-y-0.5 active:scale-90 active:translate-y-0"
          >
            <img
              src={messageIcon3D}
              alt=""
              aria-hidden="true"
              className="w-9 h-9 object-contain select-none pointer-events-none drop-shadow-[0_4px_8px_rgba(59,130,246,0.35)]"
              draggable={false}
            />
