  ...
  return (
    <div className="relative h-screen overflow-hidden bg-[#121214] text-slate-200">
      ...
      <div className="flex h-full flex-col">
        ...
        <div
          className={`flex flex-1 min-h-0 ${(active === "Home" || active === "Marketplace") && !isDesktop && !desktopLanding ? "pt-12 md:pt-[4.5rem]" : ""} ${desktopLanding && active === "Marketplace" ? "pt-0 md:pt-0" : ""}`}
        >
