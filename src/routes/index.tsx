      ...
      <div className="flex h-full flex-col">
        ...
        <div className={`flex flex-1 min-h-0 ${(active === "Home" || active === "Marketplace") && !isDesktop ? "pt-12 md:pt-[4.5rem]" : ""}`}>
          ...
          <main
            ...
            className={`flex-1 min-w-0 min-h-0 ${isMessages ? "overflow-hidden" : "overflow-y-auto"} ${desktopLanding ? "" : "pb-20 md:pb-0"} ${isDesktop && (active === "Academy" || active === "Bounties" || active === "Circles") ? "bg-white" : ""}`}
          >
            {view}
          </main>
        </div>
